...
class ProductController extends Controller{
	...
	public function import(Request $request){
	    if($request->getMethod() == "POST"){
	        ...
	        $this->container->get('templating.holder')->add('main', ri('proccesed %count% rows', array('%count%' => count($data))));   
	    }
    ...
    public function export(Request $request){
        ...
        $data = Plugin::get('riUtility.DatabaseResult')->dbToArrayWithoutKey($result);
